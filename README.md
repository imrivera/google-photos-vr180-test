...
There are included 3 JPG files, the metadata is the same for all of them. The formatting for the basic XMP XML Metadata are different although all of them are equivalent. However, even being equivalent, they are handled in different ways.

The basic and extended XMP contents are also included for easier inspection as separated files _test?-basic-xmp.bin_ and _test?-ext-xmp.bin_.
...
**PROBLEM:** Google Photos shows the same image for both eyes and the perspective shown is incorrect, you are able to see the left and right sides of the photo at the same time.
...
**PROBLEM:** Google Photos show the same image for both eyes.
...
# Expected behavior
The three files should be equivalent and all of them should be displayed exactly equal in the Google Photos application.

As stated in [XMP Specification Part 1 Section 7.4](https://wwwimages2.adobe.com/content/dam/acom/en/devnet/xmp/pdfs/XMP%20SDK%20Release%20cc-2016-08/XMPSpecificationPart1.pdf):
